...
- Develop lean software that consume less CPU, less memory, less bandwidth;

- Develop high speed or real time software (response time less than X milliseconds etc.);

- Develop software of high performance, supporting X amount of users simultaneously;

- Develop software of high performance, supporting high volume of read/write of database;

- Develop software of high performance, supporting more parallel computing or more concurrency;

- Develop multi-threaded software;

- Develop more efficient algorithm that reduced the computation (from n^2 to n*log(n));

- Integrate heterogenous software systems;

- Extend the performance and functionality of a open source code base;

- Develop distributed or decentralized system, ensure data integration across the system;

- Develop secure software, secure communication, better encryption/decryption methods;

- Develop new methods of user authentication, authorization, access control etc.;

- Develop quantum random number generator, implement quantum key exchange protocol etc.;

- Develop multi qubit quantum computer, more effective decoherence, error reconciliation etc.;

- Develop quantum adiabatic system, quantum optimization;

- Develop blockchain system, defi, cefi, tokenization protocol, dex, cex etc.;

- Develop machine learning systems to achieve better prediction or more effective learning;

- Develop quantum machine learning system;

- Integrate multiple machine learning algorithms into one AI system;

- Develop more stable software that reduce the downtime significantly;
...
- Integrate new technology, new controls, new modules into an existing system;

- Develop system that consumes less energy;

- Develop system that increases productivity;

- Develop system that improves its safety;

- Develop system that improves its stability and/or its lifetime;

- Develop system that becomes more environmentally friendly, reduce waste or pollution;
...
- New cutting, forming, welding process to achieve better product property;

- Process metals or plastics with different set of temperatures, tooling, to optimize the property;

- Unusually tight tolerance machining, forming, welding;

- Process optimization by changing multiple process parameters;

- Material reclamation, such as sand reclamation;

- Environment friendly waste processing, reduce pollution;
...
- Less poison, less pollution methods;

- New formula, new materials composite, new bonding technique for better quality or durability;

- New surface finishing technique to achieve better quality;

5. Energy;

- New technology or process to increase energy efficiency;

- New technology or process to reduce heat dissipation, waste, or cost per watt;

- New technology or process to reduce pollution;

- New technology or materials to improve insulation or improve conductivity;

- Improve energy efficiency by designing and implementing smart controls;

- Improve battery life or reduce battery pollution;

6. Oil, Gas, Mining;

- Environment friendly process;

- Material reuse or reclamation;

- Mining process of higher efficiency and/or less energy consumption;

- Equipment lifetime, stability improvement;

- New software, optimization algorithm, modelling method that lead to better productivity;

7. Farming, Growing & Food Processing;

- New formulas, mixture of new ingredients for better nutritions and better food conditions;

- New methods of processing, packaging to extend food's storage time;

- New process of farming (new temperature, humidity, fertilizing, sunshine etc.) to make food more organic or fit for special purpose;

- New technology or process to increase food production per acres.

- Experiment with new soil medium or composition of medium;

- Disease curing and preventing technology or process;

- Improved animal feed composition for better or more production (egg, milk, meat etc.);

- New technology to perserve food;


8. Beverage, wine making;

- Oenology process control and optimization, optimizing composition of ingredients, enzyme, fermenting experiments;

- Grape property study, grape growing experiments, various combination of sunshine, temperature etc.;

- New bottling technology, anti spillage etc.;


9. Chemical Industry;

- Experiment new chemical formulas for better product performance;

- Develop new solution, new compound that deliver better product performance;

- Controlled chemical reactions of special purpose;

- More efficent colour making process;

- Develop new materials or derivatives of chemical process;

10. Biotechnology, Genome, Protein Analysis;

- Virology study (admittedly, we put virology as the first as this document is writted during the COVID-19 pandemic, if you have a virology study experiments, we are eager to claim SR&ED for you);
...
- Disease study, screening technology, and data analytics;

- Protein folding and composition experiments;

- Faster, or more accurate diagnostic and test toolkit;


11. Electric & Electronics Manufacturing and Assembly;

- System integration between mechanical, electrical, electronic, hydraulic sub systems;

- Smart controls to make equipment run faster, run more stably, save energy;

- New system to achieve more productivity than the existing system;

- Improve signal strength, reduce signal noise, etc.;

- Reduce electric surge and improve equipment lifetime;

12. Health Care, Dental Care;

- Clinical experiments;

- Big data analytics, machine learning to find hidden corelations and causes of disease;
